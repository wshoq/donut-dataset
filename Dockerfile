...
# --- Skopiowanie kodu i datasetu ---
COPY train.py /workspace/
COPY dataset.zip /workspace/data/dataset.zip

# --- Rozpakowanie datasetu ---
RUN mkdir -p /workspace/data
RUN unzip /workspace/data/dataset.zip -d /workspace/data/
RUN mv /workspace/data/dataset/* /workspace/data/ && rmdir /workspace/data/dataset
RUN rm /workspace/data/dataset.zip
